...
def collect_solutions(
    *, repository: str, server_url: str, leetcode_session: str | None
) -> list[Solution]:
...
def main() -> None:
    ...
    dump_problems(yaml_file, updated_problems)
    write_output(github_output, "commit_msg", build_commit_message(changed_solutions))
